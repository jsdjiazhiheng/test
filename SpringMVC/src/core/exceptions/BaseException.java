...
/**
 * 这是一个供所有应用使用的通用的超类，此类与它的子类支持多样化异常
 */
public class BaseException extends Exception  {
	
	private static final long	serialVersionUID	= -7240583947034824706L;
	 ...
	 * 同时可以填充多样化异常数组，但是initCause只有初始化根异常，并没有填充多样化异常数组的功能，但<br>
	...
	/**
	 * 上下两个方法联系的很紧，它们使行根异常与根异常集的初始化能够融为一体
	 * 
	 * @see java.lang.Throwable#initCause(java.lang.Throwable)
	 */
	@Override
	public synchronized Throwable initCause(Throwable rootCause) {
		Throwable throwable = super.initCause(rootCause);
		if (this.rootExceptions.size() < 1) {
			this.addRootException(rootCause);
		}
		return throwable;
	}
